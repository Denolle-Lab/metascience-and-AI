...
- Every meeting ends by asking what its papers change in the unit skill, [agents/skills/unit-of-inquiry/SKILL.md](../agents/skills/unit-of-inquiry/SKILL.md). Meeting 1 wrote its first version. The rules below are the ones these two papers force, each with its line in the file.
