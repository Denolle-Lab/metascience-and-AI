...
Five entries cited as arXiv preprints now have peer-reviewed versions, and the chapter was updated: Co-Scientist in Nature (Gottweis and colleagues 2026), Gravity-Bench and LLM-SRBench in ICML 2025, MLE-bench and DiscoveryBench in ICLR 2025. DiscoveryBench and the Si human study were added as rows. A-Lab (Szymanski and colleagues 2023) and its reanalysis (Leeman and colleagues 2024) were added to the systems table: a closed loop reported forty-one new compounds and the reanalysis found most were misidentified or already known. It is the clearest published case of a loop scoring itself, and the best case exercise available for meeting 13.
